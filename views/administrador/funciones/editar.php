...
$sentencia = $base_de_datos->prepare("SELECT * FROM cartas inner join car_rar
...
<h3 class="mt-5">Registrar personal PDO</h3>
	...
	<form method="post" action="guardarDatosEditados.php">
		...
		<input class="form-control" type="hidden" name="id" value="<?php echo $persona->id_car; ?>">

		<label for="nombre">Nombre:</label>
		<input class="form-control" value="<?php echo $persona->nombre_car ?>" name="nombre" required type="text" id="nombre" placeholder="Escribe tu nombre...">
