    ...
    <div class="col-md-12">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-200 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <h3 class="mb-0">¡Welcom Amore Mio!</h3>
          <p class="card-text mb-auto">¡Amore Mio~!, ¿Quieres cuidar tu coleccion o baraja principal?, ¡Tengo todo cubierto!, aqui puedes buscar todo lo que ofrecemos dentro de nuestras instalaciones, si no lo encuentras buscanos en nuestra tienda oficial..</p>
        </div>
        <div class="col-auto d-none  d-lg-block">
<img src="img/beto2.png" style="width: 200px;" alt=""> 
       </div>
      </div>
    </div>
  </div> 
...
<hr>
<h4 class="card-text mb-auto" style="text-align: start;">Precio: </h4><p class="card-text mb-auto"><?php echo $resultado->precio ?></p>
<h4 class="card-text mb-auto" style="text-align: start;">Descripcion: </h4><p class="card-text mb-auto"><?php echo $resultado->notas_prod ?></p>
</div>
